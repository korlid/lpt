                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    <h5 class="card-title">แก้ไขประเภทอุปกรณ์</h5>
                                    <?php
                                    ...
                                    <form id="frm_cus" method="post" class="contact-form" onsubmit="return function_check();">
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="text" id="name" name="name" value="<?php echo $row['name']; ?>" placeholder="กรุณากรอกชื่อประเภทสินค้า" class="form-control" autocomplete="off">
                                        </div>
