                                    ...
                                    <form id="frm_cus" method="post" class="contact-form" onsubmit="return function_check();">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                ...
                                                {
                                                ?>
                                                <img id="example_image01" src="public/uploads/product/<?php echo $row['image'] ?>" class="img-responsive img-thumbnail" style="width:100%; height:300px;"><br />
                                                <?php
                                                }
                                                else
                                                {
                                        ...
                                        <div class="row mb-3" style="margin-top:10px;">
                                            <div class="col-md-3">
                                                ...
                                                <select id="category_id" name="category_id" class="form-control">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $cate['id']; ?>" <?php if($cate['id'] == $row['category_id']){ echo 'selected'; } ?>><?php echo $cate['name']; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input id="name" name="name" class="form-control" value="<?php echo $row['name']; ?>" autocomplete="off" placeholder="กรุณากรอกชื่ออุปกรณ์">
                                            </div>
                                            <div class="col-md-3">
                                                <label>หน่วยราคา <span style="color:red;">*</span></label><br />
                                                <input type="text" id="unit" name="unit"  class="form-control" value="<?php echo $row['unit']; ?>" autocomplete="off" placeholder="กรุณากรอกหน่วยราคา">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-2">
                                                ...
                                                <input type="text" id="price" name="price"  style="text-align:right" class="form-control num_text" value="<?php echo $row['price']; ?>" autocomplete="off" placeholder="กรุณากรอกราคา">
                                            </div>
                                            <div class="col-md-2">
                                                <label>จำนวนที่เบิก <span style="color:red;">*</span></label><br />
                                                <input type="text" id="amount" name="amount" style="text-align:right" class="form-control num_text" value="<?php echo $row['amount']; ?>" autocomplete="off" placeholder="กรุณากรอกจำนวน">
                                            </div>
                                        </div>
